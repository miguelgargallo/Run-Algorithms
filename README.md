...
Es posible que de errores de permiso, tiras de
...
Este comando nos preguntará cuantas veces deseamos arrancar el codigo, y nos devolverá un total de cuatro archivos, con el primer arranque, nos dará 1 único archivo que se actualizará siempre, se trata del Libro mayor de resultados, o sea, el archivo que contiene todos los resultados de todas las partidas.
Después siempre generará 3 arvhivos mas, uno por cada seed. Estos contienen datos diferentes.

Este es un ejemplo de estructura de archivos, debes de copiar todo en la raíz.

```
/game/matches
├── archive <- Archivo de resultados acumulados de todas las partidas
│   └── book.pylar <- Libro mayor de resultados
├── data <- Datos de cada partida
│   ├── data10871.pylar <- Datos de la partida 10871
│   ├── data11094.pylar <- Datos de la partida 11094
│   ├── data11504.pylar <- Datos de la partida 11504
│   └── data9410.pylar <- Datos de la partida 9410
├── docs <- Documentación
│   ├── docs10871.pylar <- Documentación de la partida 10871
│   ├── docs11094.pylar <- Documentación de la partida 11094
│   ├── docs11504.pylar <- Documentación de la partida 11504
│   └── docs9410.pylar <- Documentación de la partida 9410
└── library <- La Biblioteca, donde está el record o console log de partidas por seed entero
    ├── match10871.pylar <- Record o console log de la partida 10871
    ├── match11094.pylar <- Record o console log de la partida 11094
    ├── match11504.pylar  <- Record o console log de la partida 11504
    └── match9410.pylar <- Record o console log de la partida 9410
```
![Pylar-FileSystem-EDA-Game](https://user-images.githubusercontent.com/5947268/205489718-3c5858bd-8eae-4c8e-9ab1-79869831e10a.png)
